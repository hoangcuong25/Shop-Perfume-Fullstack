    ...
    return (
        <Link to={`/product/${id}`} onClick={() => window.scrollTo(0, 0)}>
            <div className="flex flex-col justify-center items-center hover:scale-105 transition-all duration-500 mx-3 relative group">
                ...
                <h5 className="mt-3 lg:text-[13px] text-[12px] font-semibold">New Price: ${formatMoney(newPrice)}</h5>
                <h5 className="line-through lg:text-[13px] text-[12px] font-semibold  text-slate-400  color: rgb(71 85 105);">Old Price ${formatMoney(oldPrice)}</h5>
