...
const Sidebar = ({ sidebar, setSidebar, show }: Props) => {
    ...
    return (
        <div className={`md:flex flex-col bg-gray-100 border border-gray-300 rounded-md pt-2 w-72 h-fit shadow-md hover:shadow-lg ${show ? 'flex absolute z-50 top-32 md:top-56' : 'hidden'}`}>
